<?php namespace App\Http\Controllers;
	...
	class AdminCategoriasProdutosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "categorias_produtos";
			...
			$this->form[] = ['label'=>'Descrição','name'=>'descricao','type'=>'text','validation'=>'min:0|max:200','width'=>'col-sm-10'];
