<?php namespace App\Http\Controllers;
	...
	class AdminFaseCriacoesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Descrição','name'=>'descricao','type'=>'text','validation'=>'min:1|max:200','width'=>'col-sm-10'];
